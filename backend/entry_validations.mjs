...
export function validate_step_info(step_number, name, estimated_time_in_seconds){
    if (!step_number || !name || !estimated_time_in_seconds){
        console.error("following fields are mandatory for steps : step_number, name, estimated_time_in_seconds")
        return {valid: false, message: "step_number, name, and estimated_time_in_seconds are mandatory for steps"}
    }
